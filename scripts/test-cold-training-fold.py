...
if name=='rom_identity':
 ...
 manifest={{'schema':'fn64.snapshot-workspace','schema_version':3,'state':'open','open_reason':'no_proven_banks','normalized_rom_sha256':rd,'discovery':{{}},'limits':{{}},'snapshot_wire':{{'schema_version':5,'authority':'diagnostic_only','duplicates_fact_db_per_bank':False,'remaining_large_rom_frontier':'streaming_v5'}},'aggregate_snapshot_artifact_bytes':0,'rom_recompilation_complete':False,'remaining_recompilation_frontier':'proven_bank_and_callable_owner_closure','intended_use':'sealed_cold_function_training_input','cold_training':{{'schema_version':3,'algorithm':'fn64.cold-function-training.v3','answer_key_present':False,'candidate_artifact':'cold-candidates.json','candidate_artifact_byte_length':0,'candidate_artifact_sha256':sha(b''),'scoped_candidate_identities_v3_sha256':candidate}},'banks':[]}}
