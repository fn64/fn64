...
be regenerated under current schema v27. Their private content remains outside the
...
`typed_block_program`, or `identified_native_archive`; the resulting v27
...
cycle, and expected v27 execution source. The executable and receipt must be
...
satisfy any public-microcode requirement. Schema v27 binds RT64's resolved
...
The runner verifies each terminal v3 journal, exact v27
...
microcode-data address and length. Report schema `fn64.release-gate.v27`
...
runner, receipts, reports, and journals. They are historical under v27 and
