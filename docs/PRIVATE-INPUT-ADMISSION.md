...
be regenerated under current schema v25. Their private content remains outside the
...
`typed_block_program`, or `identified_native_archive`; the resulting v25
...
cycle, and expected v25 execution source. The executable and receipt must be
...
satisfy any public-microcode requirement. Schema v25 binds RT64's resolved
...
The runner verifies each terminal v3 journal, exact v25
...
microcode-data address and length. Report schema `fn64.release-gate.v25`
...
runner, receipts, reports, and journals. They are historical under v25 and
