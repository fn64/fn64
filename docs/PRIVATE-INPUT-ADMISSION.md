...
be regenerated under current schema v34. Their private content remains outside the
...
satisfy any public-microcode requirement. Schema v34 binds RT64's resolved
...
microcode-data address and length. Report schema `fn64.release-gate.v34`
...
runner, receipts, reports, and journals. They are historical under v34 and
...
children) on macOS arm64 on 2026-07-24. It cannot satisfy schema v34 and must
