...
retained 12 satisfied and 150 missing FullParityV1 assignments; current v32
...
plus a v32 regeneration campaign.
...
| X5 | Regenerate the private full-ROM series under schema v32. | private ROM access; M0.3-adjacent |
...
| H5 `full-rom-zero-unsupported` | **evidence** (private ROMs) + a v32 regeneration campaign | no ROM bytes may enter git; manifests live outside the repo |
