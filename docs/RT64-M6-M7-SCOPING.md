...
retained 12 satisfied and 150 missing FullParityV1 assignments; current v31
...
plus a v31 regeneration campaign.
...
| X5 | Regenerate the private full-ROM series under schema v31. | private ROM access; M0.3-adjacent |
...
| H5 `full-rom-zero-unsupported` | **evidence** (private ROMs) + a v31 regeneration campaign | no ROM bytes may enter git; manifests live outside the repo |
