...
`docs/rt64/RT64-WM2000-FRAME-RATE-MEASURED.md` and the scheduling change in commit
...
(`crates/fn64-abi/src/task_dispatch/rsp_commit/dispatch_lle.rs:34`). In the measured
