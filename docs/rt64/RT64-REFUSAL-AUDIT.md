...
(`docs/rt64/RT64-M6-M7-SCOPING.md`, which does substantiate it). No file in this
...
| `rt64_plume.h` | refused | **STILL VALID** | Not portable. Five lines; the only refusal in this batch whose citation substantiates it (`docs/rt64/RT64-M6-M7-SCOPING.md:95-103`, `:367`). |
...
All 10 cite `docs/rt64/RT64-GUI-ASSESSMENT.md`, which names every one. This is the
...
| `rt64_microcode.h` | refused | **STILL VALID** | Not portable. Verified: two `uint32_t` fields and nothing else. Best-reasoned refusal in the batch (§3.7 of the standing brief: field order is not pinnable). |
...
| `rt64_raster_shader_cache.h` | refused | **STILL VALID** | Not portable. Thread/mutex/queue members; substantiated by `docs/rt64/RT64-M6-M7-SCOPING.md:62`, `:96-99`. |
...
| `rt64_render_worker.cpp` | refused | **STILL VALID** | Not portable. Pure plume RHI; substantiated at `docs/rt64/RT64-M6-M7-SCOPING.md:87`. |
| `rt64_render_worker.h` | refused | **STILL VALID** | Not portable. Substantiated at `docs/rt64/RT64-M6-M7-SCOPING.md:86`. |
