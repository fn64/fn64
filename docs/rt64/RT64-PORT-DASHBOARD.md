...
- Done, and provably so: color_converter.rs now carries both SHA-256 citations, and docs/rt64/rt64-port-inventory.json reports src/hle/rt64_color_converter.cpp and .h as port_state=ported with ported_as pointing at crates/fn64-render-wgpu/src/color_converter.rs. That inventory flip is this card's own declared exit condition, met.
