...
`docs/rt64/RT64-WM2000-INMATCH-GAPS.md` raises, as "a silent wrong-colour path the
...
precisely the coincident-fixture trap `docs/rt64/RT64-WM2000-HARNESS-TRAPS.md`
...
`docs/rt64/RT64-WM2000-INMATCH-GAPS.md` set the decision rule for this
...
proposed in `docs/rt64/RT64-WM2000-INMATCH-GAPS.md` as the measurement that would
