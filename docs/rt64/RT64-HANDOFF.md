...
> Read `docs/rt64/RT64-HANDOFF.md` on branch `port/rt64-conveyor` and continue from
...
stale.** `docs/rt64/RT64-PERF-CEILING.md` (which I wrote) cites
...
The reasoning is in `docs/rt64/RT64-ENGINEERING-LOOP.md`; the short form:
...
4. **DONE, and the texel noise is CLOSED.** The cause was the deferred
   ...
   `docs/rt64/RT64-WM2000-TEXTURE-STATE.md`): skin tones, facial detail, a
...
Full list in `docs/rt64/RT64-WM2000-HARNESS-TRAPS.md`. The ones that cost the most:
