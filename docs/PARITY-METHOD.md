...
- Schema-v33 fixed-cycle device/framebuffer/audio/memory digests,
  ...
  and require schema-v33 regeneration. The public synthetic identified-native
  ...
  requires schema-v33 regeneration. Compiler, SDK, or target drift also fails
