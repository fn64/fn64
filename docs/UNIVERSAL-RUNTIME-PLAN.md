...
earlier whole-shard ROM-free contracts passed the deterministic bar; the
exact-entry wrapper contract still requires its post-migration run. Earlier real runs reached
...
The exact-entry real-ROM comparison at 100,000 instructions remains pending.
No real-ROM exact-entry equality result is claimed until it succeeds.
