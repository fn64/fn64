...
pixels across distinct presents; and different seeds change them. Divot,
RGBA16 dither restoration, and all four AA selectors remain exact pixel-inert
native residuals because their source-neighborhood or coverage inputs do not
yet survive to the final VI shader. Gamma dither uses a deterministic,
