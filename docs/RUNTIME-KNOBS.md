...
| fn64-abi | `FN64_AUDIO_PRIORITY_JOIN_BUDGET_MS` | `crates/fn64-abi/src/task_dispatch/lifecycle.rs:1150` | 6 | runtime | diagnostic | Tunes the audio-priority bounded VI join budget; perf-tuning knob, not a player setting. |
...
| fn64-abi | `FN64_AUDIO_TASK_LOG` | `crates/fn64-abi/src/task_dispatch/lifecycle.rs:3523` | 2 | runtime | diagnostic | Per-task audio dispatch logging. |
...
| fn64-abi | `FN64_DUMP_AUDIO_TASK_INDEX` | `crates/fn64-abi/src/task_dispatch/rsp_commit.rs:4238` | 3 | runtime | diagnostic | Selects which audio task index to dump. |
| fn64-abi | `FN64_EXECUTOR_SPLIT` | `crates/fn64-abi/src/counter_tree.rs:127` | 32 | runtime | diagnostic | Enables the coroutine-executor split instrumentation/Cell used by task_dispatch lifecycle timing. |
...
| fn64-abi | `FN64_PROFILE_BASELINE_MS` | `crates/fn64-abi/src/frame_census.rs:1978` | 1 | runtime | diagnostic | Baseline milliseconds input to the FN64_PROFILE report. |
| fn64-abi | `FN64_PROFILE_CONTROL` | `crates/fn64-abi/src/frame_census.rs:1973` | 1 | unknown | diagnostic | Control-arm label for an FN64_PROFILE A/B report. |
| fn64-abi | `FN64_PROFILE_CONTROL_MS` | `crates/fn64-abi/src/frame_census.rs:1975` | 1 | unknown | diagnostic | Control-arm milliseconds input to an FN64_PROFILE A/B report. |
| fn64-abi | `FN64_PROFILE_EXCEPTIONS` | `crates/fn64-abi/src/recompiled/execution.rs:1869` | 1 | runtime | diagnostic | Profiling exceptions/exclusion list for the execution report. |
| fn64-abi | `FN64_RAW_DPC_STREAM_DUMP_COUNT` | `crates/fn64-abi/src/task_dispatch/rsp_commit.rs:39` | 1 | unknown | diagnostic | How many raw-DPC stream entries the dump captures. |
| fn64-abi | `FN64_RAW_DPC_STREAM_DUMP_DIR` | `crates/fn64-abi/src/task_dispatch/rsp_commit.rs:26` | 2 | runtime | diagnostic | Output directory for the raw-DPC stream dump. |
| fn64-abi | `FN64_RAW_DPC_STREAM_DUMP_RDRAM` | `crates/fn64-abi/src/task_dispatch/rsp_commit.rs:41` | 1 | unknown | diagnostic | Includes rdram context in the raw-DPC stream dump. |
...
| fn64-abi | `FN64_TRACE_AI_BUFFERS` | `crates/fn64-abi/src/task_dispatch/setup.rs:32` | 1 | runtime | diagnostic | Traces AI (audio interface) buffer delivery. |
| fn64-abi | `FN64_TRACE_CONT` | `crates/fn64-abi/src/si/mod.rs:1119` | 2 | runtime | diagnostic | Traces controller (CONT) command activity. |
| fn64-abi | `FN64_TRACE_PI_DMA` | `crates/fn64-abi/src/pi/mmio.rs:594` | 2 | runtime | diagnostic | Traces PI DMA activity. |
| fn64-abi | `FN64_XBUS_DIFF_TRACE` | `crates/fn64-abi/src/task_dispatch/rsp_commit.rs:126` | 1 | runtime | diagnostic | Traces XBUS diff activity. |
...
| fn64-boot-harness | `FN64_BUILD_TARGET` | `crates/fn64-boot-harness/src/platform_certification.rs:759` | 1 | build-time | build-time | Platform-certification provenance: recorded build target triple, read only via env!() -- baked into the binary at compile time, never a runtime knob. |
| fn64-boot-harness | `FN64_EXECUTABLE_IMAGE_GROUPS` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1753` | 2 | unknown | diagnostic | Names generated-runner executable-image groups for the build-time bootstrap; internal generation control, not a player setting. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_BOOTSTRAP_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:57` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner bootstrap stage. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_CPU_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:65` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner CPU stage. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_HOST_ABI_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:74` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner host-ABI stage. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_PI_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:82` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner PI stage. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_RDP_RENDERER_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:92` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner RDP/renderer stage. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_RSP_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:100` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner RSP stage. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_SI_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:113` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner SI stage. |
| fn64-boot-harness | `FN64_GENERATED_RUNNER_SP_NONCE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:121` | 1 | unknown | diagnostic | Cache-busting nonce for the generated-runner SP stage. |
| fn64-boot-harness | `FN64_GUARD_MAX_RSS_MIB` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1498` | 4 | unknown | diagnostic | Release-run resource guard: max resident memory before the guard aborts the run. |
| fn64-boot-harness | `FN64_GUARD_MAX_SECONDS` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1503` | 4 | unknown | diagnostic | Release-run resource guard: max wall-clock seconds before the guard aborts the run. |
| fn64-boot-harness | `FN64_GUARD_MIN_FREE_PERCENT` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1500` | 4 | unknown | diagnostic | Release-run resource guard: minimum free-disk percentage before the guard aborts the run. |
| fn64-boot-harness | `FN64_PRIVATE_RUN_CONTRACT` | `crates/fn64-boot-harness/src/private_input_admission/mod.rs:44` | 1 | unknown | diagnostic | Private-input-admission provenance: names the run's admission contract. |
| fn64-boot-harness | `FN64_PRIVATE_RUN_CONTRACT_SHA256` | `crates/fn64-boot-harness/src/private_input_admission/mod.rs:45` | 1 | unknown | diagnostic | Private-input-admission provenance: content hash of the admission contract. |
| fn64-boot-harness | `FN64_PRIVATE_RUN_ID` | `crates/fn64-boot-harness/src/private_input_admission/mod.rs:47` | 1 | unknown | diagnostic | Private-input-admission provenance: identifies one private run. |
| fn64-boot-harness | `FN64_PRIVATE_RUN_ORDINAL` | `crates/fn64-boot-harness/src/private_input_admission/mod.rs:46` | 1 | unknown | diagnostic | Private-input-admission provenance: ordinal of one private run in a series. |
| fn64-boot-harness | `FN64_RELEASE_GATE_CYCLE` | `crates/fn64-boot-harness/src/private_input_admission/mod.rs:41` | 2 | unknown | diagnostic | Release-run-environment field: gate cycle identifier. |
| fn64-boot-harness | `FN64_RELEASE_MICROCODE_DATA_PATH` | `crates/fn64-boot-harness/src/private_release_series/mod.rs:15` | 1 | unknown | diagnostic | Release-series input: path to microcode data image. |
| fn64-boot-harness | `FN64_RELEASE_MICROCODE_TEXT_PATH` | `crates/fn64-boot-harness/src/private_release_series/mod.rs:14` | 1 | unknown | diagnostic | Release-series input: path to microcode text image. |
| fn64-boot-harness | `FN64_RELEASE_REPORT` | `crates/fn64-boot-harness/src/private_input_admission/mod.rs:42` | 3 | unknown | diagnostic | Release-run-environment field: output report path. |
...
| fn64-boot-harness | `FN64_WM_PREPARED_PRODUCER_CARGO_SOURCE_SHA256` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1745` | 1 | unknown | diagnostic | Generated-runner build provenance: content hash of the producer's cargo source. |
| fn64-boot-harness | `FN64_WM_PREPARED_PRODUCER_LOCK_SHA256` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1737` | 1 | unknown | diagnostic | Generated-runner build provenance: content hash of the producer's lockfile. |
| fn64-boot-harness | `FN64_WM_PREPARED_PRODUCER_MANIFEST_SHA256` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1733` | 1 | unknown | diagnostic | Generated-runner build provenance: content hash of the producer's manifest. |
| fn64-boot-harness | `FN64_WM_PREPARED_SHARD_ROOT` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:128` | 1 | unknown | diagnostic | Generated-runner build: prepared-shard root path, distinct from the top-level FN64_SHARD_ROOT input. |
| fn64-boot-harness | `FN64_WM_PREPARED_SOURCE_MODE` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1723` | 1 | unknown | diagnostic | Generated-runner build provenance: source mode used to prepare the WM shard. |
| fn64-boot-harness | `FN64_WM_PREPARED_TREE_DESCRIPTOR_SHA256` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:1725` | 1 | unknown | diagnostic | Generated-runner build provenance: content hash of the prepared tree descriptor. |
| fn64-boot-harness | `FN64_WM_SHARD_DIR` | `crates/fn64-boot-harness/src/generated_runner_build/build.rs:867` | 10 | build-time | build-time | Generated-runner build: working directory for one WM shard, read only via env!() (all 10 call sites in generated_runner_build/{mod,build}.rs) -- no runtime env::var/var_os read exists for this name; it is emitted by build.rs's cargo:rustc-env and baked in at compile time. |
| fn64-boot-harness | `FN64_WM_SHARD_TITLE` | `crates/fn64-boot-harness/src/generated_runner_build/mod.rs:150` | 1 | unknown | diagnostic | Generated-runner build: title label for one WM shard. |
| fn64-cpu-runtime | `FN64_COP1_RN_FINITE_FAST` | `crates/fn64-cpu-runtime/src/fpu.rs:388` | 3 | runtime | diagnostic | FPU round-to-nearest fast-path A/B control for measurement against the exact path. |
| fn64-cpu-runtime | `FN64_WATCH_WRITE` | `crates/fn64-cpu-runtime/src/runtime/host.rs:24` | 4 | runtime | diagnostic | Arms a watched-write address trap in the CPU runtime. |
...
| fn64-cpu-runtime-codegen | `FN64_ROM` | `crates/fn64-cpu-runtime-codegen/src/bin/recompile_rom.rs:21` | 7 | runtime | user | recompile_rom CLI: input ROM path; a normal invocation sets this. |
...
| fn64-render-conformance | `FN64_GBI_PACKET_DUMP` | `crates/fn64-render-conformance/src/bin/fn64-render-conformance-parity-runner.rs:3086` | 7 | unknown | test-only | render-conformance parity runner: dumps captured GBI packets for a case. |
| fn64-render-conformance | `FN64_GENERATE` | `crates/fn64-render-conformance/src/bin/fn64-render-conformance-parity-runner.rs:5890` | 2 | runtime | test-only | render-conformance parity runner: generator mode, emits the synthetic corpus. |
| fn64-render-conformance | `FN64_ONLY` | `crates/fn64-render-conformance/src/bin/fn64-render-conformance-parity-runner.rs:5810` | 2 | runtime | test-only | render-conformance parity runner: filters the corpus to a named case/prefix. |
| fn64-render-conformance | `FN64_WM2000_PACKET_ENTRY` | `crates/fn64-render-conformance/src/bin/fn64-render-conformance-parity-runner.rs:3099` | 1 | unknown | test-only | render-conformance parity runner: selects one WM2000 packet-capture entry. |
| fn64-render-conformance | `FN64_WM2000_PACKET_TSV` | `crates/fn64-render-conformance/src/bin/fn64-render-conformance-parity-runner.rs:3097` | 1 | unknown | test-only | render-conformance parity runner: path to the WM2000 packet-capture TSV. |
| fn64-render-ir | `FN64_TMEM_UNIFORM_DIGEST_V2` | `crates/fn64-render-ir/src/ticket.rs:404` | 3 | runtime | diagnostic | Enables the v2 TMEM-uniform digest computation for cross-check. |
| fn64-render-reference | `FN64_DIAG_AFFINE_TEXTURE` | `crates/fn64-render-reference/src/raster/draw.rs:1175` | 1 | runtime | diagnostic | A/B diagnostic for affine-texture rasterization, named FN64_DIAG_* by convention. |
| fn64-render-reference | `FN64_DIAG_IGNORE_SCISSOR` | `crates/fn64-render-reference/src/raster/draw.rs:1121` | 1 | runtime | diagnostic | A/B diagnostic that ignores the scissor rect during rasterization. |
| fn64-render-reference | `FN64_DIAG_OLD_LIGHT_SLOT` | `crates/fn64-render-reference/src/gbi/matrix.rs:271` | 1 | runtime | diagnostic | A/B diagnostic reverting to the pre-fix light-slot reservation count, to compare against the corrected DMEM-offset decode. |
| fn64-render-reference | `FN64_DUMP_PROJ` | `crates/fn64-render-reference/src/gbi/geometry.rs:304` | 12 | unknown | diagnostic | Dumps projection-matrix state during GBI processing. |
| fn64-render-reference | `FN64_GBI_CENSUS` | `crates/fn64-render-reference/src/gbi/census.rs:10` | 5 | unknown | diagnostic | Census of GBI command dispatch. |
| fn64-render-reference | `FN64_GBI_CENSUS_OUT` | `crates/fn64-render-reference/src/gbi/census.rs:12` | 3 | runtime | diagnostic | Output path for the GBI census. |
| fn64-render-reference | `FN64_GBI_CENSUS_PER_TASK` | `crates/fn64-render-reference/src/gbi/census.rs:81` | 3 | unknown | diagnostic | Per-task breakdown for the GBI census. |
| fn64-render-reference | `FN64_GBI_OTHERMODE_CENSUS` | `crates/fn64-render-reference/src/gbi/census.rs:1056` | 4 | unknown | diagnostic | Census of othermode register changes. |
| fn64-render-reference | `FN64_GBI_OTHERMODE_CENSUS_OUT` | `crates/fn64-render-reference/src/gbi/census.rs:1058` | 3 | runtime | diagnostic | Output path for the othermode census. |
| fn64-render-reference | `FN64_GBI_PACKET_DUMP_ENTRIES` | `crates/fn64-render-reference/src/gbi/census.rs:787` | 3 | runtime | diagnostic | Entry count for the GBI packet dump (reference-renderer side, distinct from the conformance-runner knob of the same family). |
| fn64-render-reference | `FN64_GBI_PACKET_DUMP_OUT` | `crates/fn64-render-reference/src/gbi/census.rs:794` | 3 | runtime | diagnostic | Output path for the GBI packet dump (reference-renderer side). |
| fn64-render-reference | `FN64_GBI_TEXRECT_CENSUS` | `crates/fn64-render-reference/src/gbi/census.rs:334` | 4 | unknown | diagnostic | Census of texrect commands. |
| fn64-render-reference | `FN64_GBI_TEXRECT_CENSUS_OUT` | `crates/fn64-render-reference/src/gbi/census.rs:336` | 3 | runtime | diagnostic | Output path for the texrect census. |
| fn64-render-reference | `FN64_GFX_TASK_DUMP` | `crates/fn64-render-reference/src/backend/imp.rs:396` | 3 | runtime | diagnostic | Dumps graphics-task structures. |
| fn64-render-reference | `FN64_GFX_TASK_DUMP_DIR` | `crates/fn64-render-reference/src/backend/imp.rs:405` | 2 | runtime | diagnostic | Output directory for the graphics-task dump. |
| fn64-render-reference | `FN64_NO_DEPTH` | `crates/fn64-render-reference/src/backend/imp.rs:582` | 2 | unknown | diagnostic | A/B toggle disabling depth-based ordering, documented as painter's-order comparison. |
| fn64-render-rt64 | `FN64_RT64_ADAPTER_SOURCE_SHA256` | `crates/fn64-render-rt64/src/backend_impl.rs:154` | 1 | build-time | build-time | RT64 backend provenance: content hash of the adapter source, read only via env!() -- baked into the binary at compile time, never a runtime knob. |
| fn64-render-rt64 | `FN64_RT64_SOURCE_ID` | `crates/fn64-render-rt64/src/backend_impl.rs:96` | 2 | build-time | build-time | RT64 backend provenance: source identifier for the active adapter, read only via env!() -- baked into the binary at compile time, never a runtime knob. |
...
| fn64-shell | `FN64_AUDIO_PRIORITY` | `crates/fn64-shell/src/cli.rs:150` | 5 | unknown | user | Enables audio-priority scheduling in the shell; a player/porter-facing runtime setting. |
...
| fn64-shell | `FN64_CART_HANDLE_VRAM` | `crates/fn64-shell/src/cli.rs:178` | 2 | unknown | user | Overrides the cart-handle VRAM address for titles the default probe does not cover; documented example override in main.rs. |
| fn64-shell | `FN64_DEMO_FRAMES` | `crates/fn64-shell/src/cli.rs:192` | 3 | unknown | user | Controls how many frames the demo/showcase mode renders; a normal demo invocation sets this. |
| fn64-shell | `FN64_DEMO_ZOOM_FILL` | `crates/fn64-shell/src/cli.rs:197` | 5 | unknown | user | Controls demo-mode zoom/fill framing; a normal demo invocation sets this. |
...
| fn64-shell | `FN64_FRAME_DUMP` | `crates/fn64-shell/src/cli.rs:206` | 3 | unknown | diagnostic | Dumps rendered frames to disk. |
...
| fn64-shell | `FN64_HUD` | `crates/fn64-shell/src/cli.rs:164` | 10 | unknown | user | Toggles the on-screen HUD overlay; a normal player-facing display setting. |
| fn64-shell | `FN64_INPUT_PROBE` | `crates/fn64-shell/src/cli.rs:213` | 4 | unknown | diagnostic | Probes controller input delivery. |
| fn64-shell | `FN64_NO_AUDIO` | `crates/fn64-shell/src/cli.rs:159` | 8 | unknown | user | Disables audio output; a normal player-facing runtime setting. |
| fn64-shell | `FN64_OVERSCAN` | `crates/fn64-shell/src/cli.rs:169` | 4 | unknown | user | Controls display overscan/safe-area cropping; a normal player-facing display setting. |
...
| fn64-shell | `FN64_PRESENT_CACHE` | `crates/fn64-shell/src/cli.rs:201` | 3 | unknown | diagnostic | A/B control for the present-frame cache. |
...
| fn64-shell | `FN64_RESIDENT_SECTIONS` | `crates/fn64-shell/src/cli.rs:183` | 2 | unknown | user | Overrides the always-resident section count for a title; documented example override for games whose resident layout differs from the OoT/NWXE defaults. |
| fn64-shell | `FN64_SCREENSHOT_DIR` | `crates/fn64-shell/src/cli.rs:173` | 3 | unknown | user | Output directory for shell screenshots; a normal player-facing setting. |
