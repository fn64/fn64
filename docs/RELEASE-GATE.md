...
metadata. The DeviceState v6 wire additionally binds the future-affecting raw
VRU initialization-sequence position. Host pointer values are excluded while
