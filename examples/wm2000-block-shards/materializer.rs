...
/// The one shard inventory, shared verbatim with the generator, the WM root
/// pack build and the verifier. See `shard_inventory.in` for why it is one
/// file. No consumer states the count: it follows from the data.
