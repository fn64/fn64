...
Reads the strict manifest at docs/rt64/rt64-port-status.json (checked against
docs/rt64/rt64-port-status-schema.json) and renders three views from one source of
truth: a concise terminal table (--terminal), generated Markdown
(docs/rt64/RT64-PORT-DASHBOARD.md), and a self-contained responsive local HTML
...
SCHEMA_PATH = ROOT / "docs/rt64/rt64-port-status-schema.json"
STATUS_PATH = ROOT / "docs/rt64/rt64-port-status.json"
MARKDOWN_PATH = ROOT / "docs/rt64/RT64-PORT-DASHBOARD.md"
...
def render_markdown(program: dict, milestones: dict[str, dict], tickets: list[dict]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        "<!-- Generated by tools/rt64_port_dashboard.py from docs/rt64/rt64-port-status.json. -->",
