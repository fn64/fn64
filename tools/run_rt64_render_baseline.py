...
SCHEMA_PATH = ROOT / "docs/rt64/rt64-render-measurement-schema.json"
DOC_PATH = ROOT / "docs/rt64/RT64-RENDER-MEASUREMENT.md"
...
def render_doc(schema: dict) -> str:
    ...
    lines = [
        ...
        "`docs/rt64/rt64-render-measurement-schema.json`; do not edit this file by hand.",
        "",
