...
def render_doc(inventory: dict, by_id: dict[str, dict]) -> str:
    ...
    lines = [
        ...
        "`docs/rt64/rt64-public-feature-inventory.json`; do not edit this file by hand.",
        "",
...
def main() -> int:
    ...
    parser.add_argument(
        "--inventory",
        type=Path,
        default=Path("docs/rt64/rt64-public-feature-inventory.json"),
    )
    parser.add_argument(
        "--doc",
        type=Path,
        default=Path("docs/rt64/RT64-PUBLIC-FEATURE-INVENTORY.md"),
    )
