...
MANIFEST_PATH = ROOT / "docs/rt64/rt64-port-authority.json"
DOC_PATH = ROOT / "docs/rt64/RT64-PORT-AUTHORITY.md"
...
def validate_local_consumers(manifest: dict) -> None:
    ...
    feature_inventory = json.loads((ROOT / "docs/rt64/rt64-public-feature-inventory.json").read_text())
    macos_inventory = json.loads((ROOT / "docs/rt64/rt64-macos-certification.json").read_text())
...
def render_document(manifest: dict) -> str:
    ...
    lines = [
        "# RT64 port authority",
        "",
        "<!-- Generated by tools/check_rt64_port_authority.py from docs/rt64/rt64-port-authority.json. -->",
        "",
