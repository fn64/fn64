...
AUTHORITY_PATH = ROOT / "docs/rt64/rt64-port-authority.json"
DEFAULT_JSON = ROOT / "docs/rt64/rt64-port-inventory.json"
DEFAULT_DOC = ROOT / "docs/rt64/RT64-PORT-INVENTORY.md"
...
SCOPING_EVIDENCE = "docs/rt64/RT64-M6-M7-SCOPING.md"
...
def sha256_citation_index(root: Path) -> dict[str, list[str]]:
    ...
    `docs/rt64/RT64-PORT-INVENTORY.md`'s generation note.
    """
...
def build_inventory(oracle_tree: Path, port_tree: Path, authority: dict) -> dict:
    ...
    value = {
        ...
        "authority_manifest": "docs/rt64/rt64-port-authority.json",
        "sources": {
...
def validate_inventory(value: dict, authority: dict) -> None:
    ...
    require(value["authority_manifest"] == "docs/rt64/rt64-port-authority.json", "authority manifest path changed")
...
def markdown(inventory: dict) -> str:
    ...
    output = [
        "# RT64 port inventory", "",
        "<!-- Generated by tools/rt64_port_inventory.py from two admitted clean checkouts and docs/rt64/rt64-port-authority.json. -->", "",
...
def self_test() -> None:
    ...
    plain["port_refusal"] = {"commit": "0" * 40, "evidence": "docs/rt64/RT64-PORT-AUTHORITY.md", "reason": "asserted"}
