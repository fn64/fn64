...
//! `f0728a2520d5aa735886240de3fee75cc805f6d6` (`docs/rt64/RT64-PORT-AUTHORITY.md`),
...
//! (`docs/rt64/rt64-port-authority.json`'s `port_source`), cited above by the
...
//! port digest per `docs/rt64/rt64-port-inventory.json`'s `sources.oracle.sha256`
...
//! `docs/rt64/RT64-PORT-AUTHORITY.md`), so `hlslpp::float4`/`hlslpp::uint4` are
