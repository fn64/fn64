...
//
// Rebaselined 2026-09-07 (Task 4.4, "single-source WGSL bodies"):
// `crate::alpha_compare::ALPHA_COMPARE_FRAGMENT_FN_WGSL` and
// `crate::coverage::COVERAGE_FRAGMENT_FN_WGSL` (two of this combined
// source's inputs) are now assembled from a shared body file plus each
// wrapper's own header/tail (see those modules' doc comments), which added
// explanatory header text to both -- a pure documentation change, no
// arithmetic or wiring changed. That grew the combined source from
// 103,984 to 104,770 bytes and changed both digests below accordingly.
// Old digests (pre-Task-4.4, for the record):
//   source:  ec a5 2e 28 92 c0 0b 02 09 ea b2 b2 0a 89 d7 cb
//            91 c4 99 11 5a 1e 9f 97 73 61 0f 2c 23 88 bf 9e
//   fixture: 84 7e d2 fd a1 5e db 32 ef 12 97 62 f6 c8 c2 f2
//            3c 3e ca a4 ec 94 c4 81 2b 18 b2 f3 05 90 20 f7
pub const TRIANGLE_PIPELINE_FRAGMENT_SOURCE_SHA256: [u8; 32] = [
    0x25, 0xc0, 0xd3, 0xfe, 0x52, 0x87, 0xad, 0x49, 0xf4, 0x84, 0x3d, 0x35, 0x09, 0x2e, 0x7b, 0x38,
    0x64, 0x6f, 0xbd, 0x40, 0xf0, 0x32, 0x23, 0xac, 0x15, 0xf4, 0xac, 0x07, 0x68, 0x6a, 0xcd, 0xcc,
];
pub const TRIANGLE_PIPELINE_FRAGMENT_FIXTURE_SHA256: [u8; 32] = [
    0xe0, 0x32, 0x56, 0xa9, 0xbf, 0x72, 0xe3, 0x7e, 0x84, 0x58, 0x60, 0x09, 0x0d, 0xa9, 0xb6, 0x8b,
    0x4c, 0x93, 0xcf, 0x4a, 0x20, 0xe9, 0xf9, 0xb4, 0xe3, 0x39, 0x27, 0x35, 0x4c, 0xff, 0x79, 0x9c,
];
pub const TRIANGLE_PIPELINE_FRAGMENT_SOURCE_BYTES: u32 = 104_770;
