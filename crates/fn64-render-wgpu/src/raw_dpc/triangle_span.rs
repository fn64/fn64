...
// the ACFF disproof), not pending wiring -- part of the same
// attribute-sampling path as AttributeSampleLine/Row below.
#[allow(dead_code)]
...
// Same 4a99af32 retention as attribute_plane above.
#[allow(dead_code)]
#[inline]
...
// delta_y_eighth/left_x/right_x/major_x/sample_x_eighths feed the
// attribute-sampling path (attribute_plane above), retained per 4a99af32's
// "reusable unwired foundations" decision; only covered_x is read today.
#[derive(Clone, Copy)]
#[allow(dead_code)]
