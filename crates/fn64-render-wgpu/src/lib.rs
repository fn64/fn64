...
pub use tmem::{
    ...
    resolve_indexed_texel, sample_committed_point, unpack_ci4_texel, AddressedTextureCell,
    AddressedTmemTexel, Ci4Palette, Ci4PaletteError, Ci4UnpackError, CommittedTextureCell,
    ...
    TextureCellSampleError, TextureCoordinateS10_5, TextureImage, TileAddressMode, TileCoordinate,
