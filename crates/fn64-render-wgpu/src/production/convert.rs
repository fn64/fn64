...
pub(super) fn image_format(format: fn64_render::NeutralImageFormat) -> crate::ImageFormat {
    match format {
...
/// different change.
pub(super) fn neutral_image_format(format: crate::ImageFormat) -> fn64_render::NeutralImageFormat {
    match format {
...
pub(super) fn neutral_pixel_size(size: crate::PixelSize) -> fn64_render::NeutralPixelSize {
    match size {
...
pub(super) fn neutral_tile_descriptor(
...
pub(super) fn neutral_tile_size(size: crate::TileSize) -> fn64_render::NeutralTileSize {
...
pub(super) fn durable_neutral_tiles(
    state: &RdpState,
) -> [(
...
pub(super) fn pixel_size(size: fn64_render::NeutralPixelSize) -> crate::PixelSize {
    match size {
...
pub(super) fn execute_scheduled_fill(
...
pub(super) fn decode_scheduled_raw_triangle(
    collector: &ExecutionCollector<'_>,
    index: CommandIndex,
...
pub(super) fn decoded_scheduled_raw_triangle(
...
pub(super) fn scheduled_raw_triangle_accesses(
    collector: &ExecutionCollector<'_>,
    candidate: &CandidateColorTarget,
    index: CommandIndex,
...
pub(super) fn execute_scheduled_raw_triangle<S: crate::TmemByteSource + ?Sized>(
    collector: &ExecutionCollector<'_>,
    candidate: &CandidateColorTarget,
    index: CommandIndex,
...
#[allow(clippy::too_many_arguments)]
pub(super) fn execute_scheduled_texrect<S: crate::TmemByteSource + ?Sized>(
    collector: &ExecutionCollector<'_>,
    candidate: &CandidateColorTarget,
    tmem: &S,
    expect_proposed: bool,
...
pub(super) fn texrect_scissor_or_full_target(
...
pub(super) fn project_pending_tmem_per_triangle(
...
pub(super) fn verify_tmem_identity<S: crate::TmemByteSource + ?Sized>(
    tmem: &S,
    expect_proposed: bool,
...
pub(super) fn project_proposed_image<S: crate::TmemByteSource + ?Sized>(
    image: &S,
...
pub(super) fn verify_accesses_inside(
...
pub(super) fn fill_accesses<'plan>(
...
pub(super) fn fill_completed_writes(
    key: ColorTargetKey,
