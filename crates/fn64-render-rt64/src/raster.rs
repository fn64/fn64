...
use crate::gbi::{CullMode, ScissorRect, Triangle, Vertex};
        ...
        for y in min_y..max_y {
            for x in min_x..max_x {
                ...
                if w0 >= 0.0 && w1 >= 0.0 && w2 >= 0.0 {
                    ...
                    // default OoT combiner (F3DEX2-CONCEPTS.md §5.2).
                    // Interpolate S/w, T/w, and 1/w, then divide. RT64 keeps
                    // homogeneous w in RasterVS.hlsl:21/36-38 and emits UV as
                    // ordinary (perspective-default) TEXCOORD in
