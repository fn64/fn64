    ...
    fn bev_vectors_require_the_in_process_closed_status_and_source_invariant() {
        ...
        forged_host.host_bindings[0].current_status_effect =
            HostCurrentStatusEffectV1::PreservesBev;
        assert_eq!(
        ...
        wrong_vector.exception_vectors[0].disposition =
    ...
    fn conditional_cpu_store_is_generation_bound_and_stays_open() {
        ...
        conditional.cpu_store_watched_destinations =
            MODELED_EXCEPTION_VECTOR_DESTINATIONS_V1.to_vec();
