...
pub fn bg_breakwall_lava_cover_move(ctx: &mut RecompContext, mem: &mut Rdram) {
    fn64_cpu_runtime::notify_function_entry(fn64_cpu_runtime::TranslatedFunctionIdentity::new(0x80901694, "bg_breakwall_lava_cover_move"));
    ...
    'run: loop { match pc {
        0x80901694 => {
            ...
            if ctx.fpu_add_s(10, 6, 8) { fn64_cpu_runtime::trap_unsupported("enabled COP1 exception"); }
