// Generated by fn64-cpu-runtime (ELF/symbol front-end).
...
pub const FN64_FUNCTION_ENTRY_OBSERVATION_SCHEMA: fn64_cpu_runtime::FunctionEntryObservationSchema = fn64_cpu_runtime::FUNCTION_ENTRY_OBSERVATION_SCHEMA;
...
pub fn callee(ctx: &mut RecompContext, mem: &mut Rdram) {
    fn64_cpu_runtime::notify_function_entry(fn64_cpu_runtime::TranslatedFunctionIdentity::new(0x80001000, "callee"));
...
pub fn caller(ctx: &mut RecompContext, mem: &mut Rdram) {
    fn64_cpu_runtime::notify_function_entry(fn64_cpu_runtime::TranslatedFunctionIdentity::new(0x80002000, "caller"));
...
pub fn tail_caller(ctx: &mut RecompContext, mem: &mut Rdram) {
    fn64_cpu_runtime::notify_function_entry(fn64_cpu_runtime::TranslatedFunctionIdentity::new(0x80003000, "tail_caller"));
    ...
    'run: loop { match pc {
        0x80003000 => {
            ...
            // nop
            call_host_or_recompiled(0x80001000, callee, ctx, mem); return;
        }
        _ => unreachable!("jumped to unmapped vram {:#X}", pc),
    } }
}
