...
//! execution is maintained in `crates/fn64-cpu-runtime/ISA-COVERAGE.md`.
...
compile_error!("fn64-cpu-runtime: production-aot and dev-interpreter are mutually exclusive");
...
/// was compiled into this exact `fn64-cpu-runtime` artifact.
...
const DYNAMIC_MAPPED_EXECUTION_LIBRARY_SOURCES_V1: &[(&str, &[u8])] = &[
    ...
    ("src/generation/mod.rs", include_bytes!("generation/mod.rs")),
    (
    ...
    ("src/semantic/tests.rs", include_bytes!("semantic/tests.rs")),
    (
...
pub use runtime::{
    ...
    host_section_resident, notify_bootstrap_or_import_write, notify_cpu_instruction_store,
    notify_function_entry, notify_host_abi_write, notify_pi_dma_write, notify_rdp_renderer_write,
    notify_rsp_execution_or_hle_writeback, notify_si_dma_write, notify_sp_dma_write, pause_self,
    resolve_banked_function, resolve_host_function, round_ties_even_f32, round_ties_even_f64,
    set_function_entry_observer, set_guest_write_boundary_observer, set_host_lookup,
    set_host_pause, set_host_section_resident, set_mmio_hooks, set_read_observer,
    ...
    FunctionEntryObserver, GuestReadEvent, GuestWriteBoundary, GuestWriteBoundaryObserver,
    GuestWriteEvent, HostFunctionCatalogErrorV1, HostFunctionCatalogV1, HostLookup, HostPause,
    HostSectionResident, IndirectTransferObservation, InstructionTranslationDiagnosticErrorV1,
    MmioRead, MmioWrite, PhysicalFgrState, Rdram, ReadObserver, RecompContext,
