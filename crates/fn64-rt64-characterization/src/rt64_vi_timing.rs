...
pub(crate) fn fb_siz(status_type: u32) -> u8 {
    match status_type {
        fn64_render_wgpu::VI_STATUS_TYPE_16_BIT => G_IM_SIZ_16B,
        fn64_render_wgpu::VI_STATUS_TYPE_32_BIT => G_IM_SIZ_32B,
...
pub(crate) fn visible(status_type: u32, h_start: u32) -> bool {
    (status_type != fn64_render_wgpu::VI_STATUS_TYPE_BLANK) && (h_start > 0)
}
